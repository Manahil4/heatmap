...
// Parsing str data cannot work for leaflet as intended
...
//         const currentLine = lines[i].split(',');
//         for (let j = 0; j < headers.length; j++) {
//             // Convert numerical fields to floating-point numbers
...
//         const currentLine = lines[i].split(',');
//         for (let j = 0; j < headers.length; j++) {
//             const value = currentLine[j].trim(); // Trim whitespace from the value
